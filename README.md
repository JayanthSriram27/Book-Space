...
[1]: https://github.com/JayanthSriram27/Book-Space/tree/main/Book%20Space%20Documentation "Title"
[2]: https://github.com/JayanthSriram27/Book-Space/tree/main/Book%20Space%20PPT "Title"
...
★ Open the command prompt and run the command: git clone https://github.com/JayanthSriram27/Book-Space/tree/main/Book%20Space
...
★ Finally to run the server use the following command: ```python3 manage.py runserver```
